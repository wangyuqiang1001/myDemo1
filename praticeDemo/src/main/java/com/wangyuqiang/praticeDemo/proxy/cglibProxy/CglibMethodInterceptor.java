package com.wangyuqiang.praticeDemo.proxy.cglibProxy;

import com.wangyuqiang.praticeDemo.proxy.javaProxy.MonitorUtil;
...
/**
 * @Description： Cglib 方法拦截器,不用依赖被代理业务类的引用。
 * 意思是委托类可以脱离引用么:
 */
